...
void setup() {
  ...
  pinMode(12, OUTPUT);// for creating flag for choosing date time setup or continuous run
  pinMode(11, INPUT);
  pinMode(4, OUTPUT);// ping 4,5 for motor control & 6 for speed control
  pinMode(5, OUTPUT);
  pinMode(8, OUTPUT);// ping 4,5 for motor control & 6 for speed control
  pinMode(9, OUTPUT);
  pinMode(10, OUTPUT);
  ...
  if ((hour == task1HourS_Stored) & (minute == task1MinS_Stored) ){
   ...
   if(task1Flag == 1){
    ...
    if (j<7)
    {
     ...
     while(i<nLEDs)
        {
          strip.setPixelColor(i,color_level,0,0);
         i++;
         if (i>=nLEDs){
         int over=i-nLEDs;
         strip.setPixelColor(over,color_level,0,0);
           
         }
         
         strip.setPixelColor(i,color_level,color_level,0);
         i++;
         if (i>=nLEDs){
         int over=i-nLEDs;
         strip.setPixelColor(over,color_level,color_level,0);
           
         }
         
         strip.setPixelColor(i,0,color_level,0);
         i++;
         if (i>=nLEDs){
         int over=i-nLEDs;
         strip.setPixelColor(over,0,color_level,0);
           
         }
         
         strip.setPixelColor(i,0,color_level,color_level);
         i++;
         if (i>=nLEDs){
         int over=i-nLEDs;
         strip.setPixelColor(over,0,color_level,color_level);
           
         }
         
         strip.setPixelColor(i,0,0,color_level);
         i++;
         if (i>=nLEDs){
         int over=i-nLEDs;
         strip.setPixelColor(over,0,0,color_level);  
         }
         strip.setPixelColor(i,color_level,0,color_level);
         i++;
         if (i>=nLEDs){
         int over=i-nLEDs;
         strip.setPixelColor(over,color_level,0,color_level);  
         }        
